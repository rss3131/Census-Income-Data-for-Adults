...
I also found it necessary to use the log values to normalize the features and us the predicted odometer readings/ Mileage of Chevrolet blazer can be seen below:
